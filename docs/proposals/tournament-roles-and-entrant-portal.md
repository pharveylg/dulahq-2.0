...
_Written 2026-09-25. Status: **slice 1 (entrant portal) built 2026-09-26** (`/entry/<id>`, phase15a: entry status, invoices, payment instructions, payment submission by the team manager). Slices 2 to 6 not started._
