    ...
    <div className="card">
      ...
      {activeTab === 'development' && (
        <div>
          ...
          <Link href={`/c/${clubSlug}/teams/${teamSlug}/players/${player.id}`} className="btn btn-primary" style={{ textDecoration: 'none' }}>
      ...
      {activeTab === 'fees' && (
        <PlayerFees clubId={clubId} teamId={teamId} playerId={player.id} charges={player.fees} canManage={canManageFees} />
      )}
