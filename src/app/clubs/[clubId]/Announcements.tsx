...
function AnnouncementRow({ clubId, announcement, canManage }: { clubId: string; announcement: Announcement; canManage: boolean }) {
...
export default function Announcements({
  ...
  return (
    <div className="card">
      ...
      {sorted.map((a) => (
        <AnnouncementRow key={a.id} clubId={clubId} announcement={a} canManage={canManage} />
      ))}
