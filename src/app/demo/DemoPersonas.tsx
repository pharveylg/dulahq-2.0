...
const PERSONAS: Persona[] = [
  {
    ...
    destination: () => '/clubs/platformconsole',
  },
  {
  ...
  },
  {
    ...
    destination: (clubSlug) => `/clubs/${clubSlug}`,
  },
  {
    ...
    destination: (clubSlug) => `/clubs/${clubSlug}/teams/demo-u12`,
  },
  {
    ...
    destination: (clubSlug) => `/clubs/${clubSlug}/teams/demo-u15`,
  },
  {
